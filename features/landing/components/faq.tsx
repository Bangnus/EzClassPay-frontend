...
const FAQ_DATA = [
  ...
  },
  {
    ...
    description: "ไม่ต้องโหลดแอปใดๆ ทั้งสิ้น! คุณสามารถใช้งาน EzClassPay ได้ทันทีผ่าน LINE เพียงแค่แอด LINE OA @EzClassPay ทุกขั้นตอนตั้งแต่เข้าห้อง ส่งสลิป ไปจนถึงแจ้งเตือนจบในแชทเดียว",
  },
  {
