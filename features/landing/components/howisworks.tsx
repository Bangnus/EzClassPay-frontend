...
const STEPS_DATA = [
  {
    ...
    description:
      "กำหนดเป้าหมาย ตั้งชื่อห้อง และเลือกโหมดการเก็บเงิน (ยอดรวมก้อนเดียว หรือ เก็บรายเดือน) ได้ง่ายๆ ในไม่กี่คลิก",
  },
  {
    step: 2,
    title: "ชวนเพื่อนเข้าร่วม",
    description:
      "แชร์ลิงก์คำเชิญ หรือให้สมาชิกสแกน QR Code เพื่อกดเข้าร่วมห้องได้ทันที โดยไม่ต้องโหลดแอปพลิเคชันให้ยุ่งยาก",
  },
  {
    step: 3,
    title: "โอนเงินและส่งสลิป",
    description:
      "สมาชิกตรวจสอบยอดค้างชำระ สแกนโอนเงินเข้าบัญชีกองกลาง และอัปโหลดสลิปเข้าสู่ระบบเพื่อแจ้งชำระเงิน",
  },
  {
    step: 4,
    title: "ตรวจสอบและยืนยันยอด",
    description:
      "ผู้ดูแลตรวจสอบและกดยืนยันยอด ระบบจะอัปเดตยอดเงินให้ทุกคนทราบแบบเรียลไทม์",
  },
];
