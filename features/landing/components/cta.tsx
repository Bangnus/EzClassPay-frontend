...
export default function CTA() {
  return (
    <div className="w-full px-[80px] py-6 mb-8">
      <div className="bg-primary rounded-[40px] px-10 py-12 flex flex-col items-center text-center shadow-lg relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <p className="text-lg text-white/90 mb-8 max-w-2xl relative z-10">
